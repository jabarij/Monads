    ...
    partial class ResultTests
    {
        public class Creation : ResultTests
        {
            ...
            public void DefaultValue_ShouldBeErrorOfDefaultValue()
            {
                ...
                // act=
                // assert
                sut.Should().BeErrorOf(default(string), because: "{0} is of default value and should be 'error of default({1})'", sut, sut.GetErrorType());
            }
            ...
            public void ParameterlessConstructor_ShouldBeErrorOfDefaultValue()
            {
                ...
                // act
                // assert
                sut.Should().BeErrorOf(default(string), because: "{0} is created using parameterless constructor and should be 'error of default({1})'", sut, sut.GetErrorType());
            }
