...
public static class EditableValueExtensions
{
    ...
    public static T Reduce<T>(this EditableValue<T> value, T defaultValue = default) =>
        value.Match(
            update: Functions.Id,
    ...
    public static TResult ReduceMap<T, TResult>(this EditableValue<T> value, Func<T, TResult> map, TResult noActionValue = default) =>
        value.Match(
            update: map,
